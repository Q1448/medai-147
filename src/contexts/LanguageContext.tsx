...
export const translations: Translations = {
  ...
  projectedHealth: { en: 'Projected Health', ru: 'Прогноз здоровья', kk: 'Денсаулық болжамы' },
  actualHealth: { en: 'Actual Health', ru: 'Фактическое здоровье', kk: 'Нақты денсаулық' },
  healthProgressChart: { en: 'Health Progress Chart', ru: 'График прогресса здоровья', kk: 'Денсаулық прогресі графигі' },
  healthChartDesc: { en: 'Green dashed line = projected improvement. Blue line = your actual scores.', ru: 'Зелёная пунктирная = прогноз. Синяя = ваши результаты.', kk: 'Жасыл пунктир = болжам. Көк = нақты нәтижелер.' },
  reanalyzeReminder: { en: 'Repeat this analysis in 1-2 days to track progress.', ru: 'Повторите анализ через 1-2 дня для отслеживания.', kk: '1-2 күнде талдауды қайталаңыз.' },
  mild: { en: 'Mild', ru: 'Лёгкая', kk: 'Жеңіл' },
  moderate: { en: 'Moderate', ru: 'Умеренная', kk: 'Орташа' },
  severe: { en: 'Severe', ru: 'Тяжёлая', kk: 'Ауыр' },
  today: { en: 'Today', ru: 'Сегодня', kk: 'Бүгін' },
  fewDays: { en: '2-3 days', ru: '2-3 дня', kk: '2-3 күн' },
  oneWeek: { en: '1 week', ru: '1 неделя', kk: '1 апта' },
  twoWeeksPlus: { en: '2+ weeks', ru: '2+ недели', kk: '2+ апта' },
  monthPlus: { en: '1+ month', ru: '1+ месяц', kk: '1+ ай' },
  symptomSeverity: { en: 'Symptom Severity', ru: 'Тяжесть симптомов', kk: 'Белгілер ауырлығы' },
  symptomDuration: { en: 'Duration', ru: 'Длительность', kk: 'Ұзақтығы' },
  bodyTemperature: { en: 'Body Temperature (°C)', ru: 'Температура тела (°C)', kk: 'Дене температурасы (°C)' },
  recentTravel: { en: 'Recent Travel', ru: 'Недавние поездки', kk: 'Жақында жасалған сапарлар' },
  recentTravelPlaceholder: { en: 'e.g., South Asia, 2 weeks ago', ru: 'например, Юго-Восточная Азия, 2 недели назад', kk: 'мысалы, Оңтүстік Азия, 2 апта бұрын' },
  waterIntake: { en: 'Daily Water Intake', ru: 'Ежедневное потребление воды', kk: 'Күнделікті су тұтыну' },
  waterIntakePlaceholder: { en: 'e.g., 1.5 liters/day', ru: 'например, 1.5 литра/день', kk: 'мысалы, 1.5 литр/күн' },
  stressLevel: { en: 'Stress Level', ru: 'Уровень стресса', kk: 'Стресс деңгейі' },
  ...
  premiumActivated: { en: 'Premium activated!', ru: 'Premium активирован!', kk: 'Premium іске қосылды!' },
  premiumActivatedDesc: { en: 'You now have unlimited access to all features.', ru: 'Теперь у вас безлимитный доступ ко всем функциям.', kk: 'Енді сізде барлық мүмкіндіктерге шексіз қол жетімділік бар.' },
  premiumActive: { en: 'Premium Active', ru: 'Premium активен', kk: 'Premium белсенді' },
  manageSubscription: { en: 'Manage Subscription', ru: 'Управление подпиской', kk: 'Жазылымды басқару' },
